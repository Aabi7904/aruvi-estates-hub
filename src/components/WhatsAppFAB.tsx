...
const WhatsAppFAB = () => {
  ...
  const phoneNumber = '919443729991';
  const message = 'Hello! I am interested in your real estate projects. Please provide more information.';
      ...
      <div className="relative">
        ...
        <AnimatePresence>
          {isHovered && (
            ...
            >
              <div className="glass rounded-xl px-4 py-2 shadow-card">

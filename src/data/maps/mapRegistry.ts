...
const mapRegistry: Record<string, ProjectMapData> = {
 ...
 "ZQGvR6X1m1BQF9SankfO": { 
  ...
  "99Maut2nAIPGlI23AcZe": { 
    id: "99Maut2nAIPGlI23AcZe",
    dimensions: { width: 2266, height: 1566 }, // Match Figma Frame size
  ...
  "lkClq9zkqzp8n5F74ogn": { 
    ...
    dimensions: { width: 9615, height: 3300 }, // Match Figma Frame size
